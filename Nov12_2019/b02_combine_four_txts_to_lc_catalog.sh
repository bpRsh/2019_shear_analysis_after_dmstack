...
#==============
# 
# Usage: bash b02_combine_four_txts_to_lc_catalog.sh [0,1]
#
# Outputs:
#=========
...
#==================================================
# NOTE:
# We denote ext_shapeHSM_HsmShapeRegauss_e1 and e2
# as g in IMCAT. So actual reduced shear g is g/2.
#==================================================
...
do # do of num
    ...
    do # do of true false
        ...
        catalogs="catalogs/catalogs_""$num""$t"
        dmstack_txt="dmstack_txt/dmstack_txt_""$num""$t"
        ...
        do # do of 0 to 99
            ...
            lc -b +all 'x = %x[0][0] %x[1][0] + %x[2][0] + %x[3][0] + 4 / %x[0][1] %x[1][1] + %x[2][1] + %x[3][1] + 4 / 2 vector' 'gm = %g[0][0] %g[1][0] + 2 / %g[0][1] %g[1][1] + 2 / 2 vector' 'gc = %g[2][0] %g[3][0] + 2 / %g[2][1] %g[3][1] + 2 / 2 vector' < ${catalogs}/merge.cat > ${final}/final_${i}.cat
